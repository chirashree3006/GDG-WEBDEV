...
export const auth = betterAuth({
  ...
  // Sign-in is Google OAuth only (restricted to VIT email accounts on
  // Google's side). Email/password self-registration is intentionally
  // disabled: it would let anyone create an account with an arbitrary,
  // unverified email address and submit applications as if they were a
  // verified student.
  emailAndPassword: {
    enabled: false,
  },
